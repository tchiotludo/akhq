import{_ as o,r as n,o as r,c,b as a,d as e,a as i,w as l,e as d}from"./app-e07feb41.js";const u={},v=a("h1",{id:"avro-deserialization",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#avro-deserialization","aria-hidden":"true"},"#"),e(" Avro deserialization")],-1),m={href:"https://avro.apache.org/docs/current/api/java/org/apache/avro/io/DatumWriter.html",target:"_blank",rel:"noopener noreferrer"},h=a("code",null,"schemas-folder",-1),p=a("code",null,"topic-regex",-1),_=a("code",null,"key-schema-file",-1),f=a("code",null,"value-schema-file",-1),b=d(`<p>Here is an example of configuration:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>akhq:
  connections:
    kafka:
      properties:
