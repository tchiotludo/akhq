import{i as e,r as t,s as n,t as r}from"./app-DcUTmZBC.js";var i=JSON.parse(`{"path":"/docs/configuration/schema-registry/glue.html","title":"Glue schema registry","lang":"en-US","frontmatter":{},"git":{"updatedTime":1781763803000,"contributors":[{"name":"Fredrik Lysén","username":"","email":"fredrik.lysen@klarna.com","commits":2}],"changelog":[{"hash":"34af1c3dfb2185865b7db3506380c0cbdd177139","time":1781763803000,"email":"flysen@users.noreply.github.com","author":"Fredrik Lysén","message":"feat(connect): add status filter to connect definitions (#2856)","coAuthors":[{"name":"Fredrik Lysén","email":"fredrik.lysen@klarna.com"}]}]},"filePathRelative":"docs/configuration/schema-registry/glue.md"}`),a={name:`glue.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="glue-schema-registry" tabindex="-1"><a class="header-anchor" href="#glue-schema-registry"><span>Glue schema registry</span></a></h1><p>Currently ,glue schema registry support is limited to only de-serialisation of avro/protobuf/json serialized messages. It can be configured as below.</p><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre><code class="language-yaml"><span class="line">  <span class="token key atrule">akhq</span><span class="token punctuation">:</span></span>
