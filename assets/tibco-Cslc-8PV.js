import{i as e,r as t,s as n,t as r}from"./app-DPh1xA4o.js";var i=JSON.parse(`{"path":"/docs/configuration/schema-registry/tibco.html","title":"TIBCO schema registry","lang":"en-US","frontmatter":{},"git":{"updatedTime":1785756406000,"contributors":[{"name":"Daniel Quiralte Ramos","username":"","email":"daniel.quiralte@masmovil.com","commits":1}],"changelog":[{"hash":"837d1df0f87af90cdbfe4853b9c492273bc2901b","time":1785756406000,"email":"daniel.quiralte@masmovil.com","author":"Daniel Quiralte Ramos","message":"feat(helm): add support for HTTPRoute and GKE HealthCheckPolicy (#2934)"}]},"filePathRelative":"docs/configuration/schema-registry/tibco.md"}`),a={name:`tibco.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="tibco-schema-registry" tabindex="-1"><a class="header-anchor" href="#tibco-schema-registry"><span>TIBCO schema registry</span></a></h1><p>If you are using the TIBCO schema registry, you will also need to mount and use the TIBCO Avro client library and its dependencies. The akhq service in a docker compose file might look something like:</p><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre><code class="language-yaml"><span class="line">  <span class="token key atrule">akhq</span><span class="token punctuation">:</span></span>
