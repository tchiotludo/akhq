import{i as e,r as t,s as n,t as r}from"./app-BGFzSVEJ.js";var i=JSON.parse(`{"path":"/docs/configuration/schema-registry/glue.html","title":"Glue schema registry","lang":"en-US","frontmatter":{},"git":{"updatedTime":1780662091000,"contributors":[{"name":"mikaelol","username":"mikaelol","email":"104485047+mikaelol@users.noreply.github.com","commits":1,"url":"https://github.com/mikaelol"}],"changelog":[{"hash":"0c197217acab4e1c28bc9345880103dd854e5ec6","time":1780662091000,"email":"104485047+mikaelol@users.noreply.github.com","author":"Mikael Olausson","message":"fix(ui): switch to sort by oldest when specifying timestamp (#2132)"}]},"filePathRelative":"docs/configuration/schema-registry/glue.md"}`),a={name:`glue.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="glue-schema-registry" tabindex="-1"><a class="header-anchor" href="#glue-schema-registry"><span>Glue schema registry</span></a></h1><p>Currently ,glue schema registry support is limited to only de-serialisation of avro/protobuf/json serialized messages. It can be configured as below.</p><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre><code class="language-yaml"><span class="line">  <span class="token key atrule">akhq</span><span class="token punctuation">:</span></span>
