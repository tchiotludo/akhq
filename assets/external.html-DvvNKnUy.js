...
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div>`,18)]))}const i=n(t,[["render",l]]),u=JSON.parse('{"path":"/docs/configuration/authentifications/external.html","title":"External roles and attributes mapping","lang":"en-US","frontmatter":{},"git":{"updatedTime":1755500358000,"contributors":[{"name":"Alexis SOUQUIERE","username":"","email":"alexis.souquiere@michelin.com","commits":1}],"changelog":[{"hash":"bc27cad7a20dd6d900465550f05a0d3e11c8232a","time":1755500358000,"email":"alexis.souquiere@michelin.com","author":"Alexis SOUQUIERE","message":"fix(auth): put the original OIDC groups mapping back (#2407)"}]},"filePathRelative":"docs/configuration/authentifications/external.md"}');export{i as comp,u as data};
