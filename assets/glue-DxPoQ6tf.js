import{i as e,r as t,s as n,t as r}from"./app-BleojAZk.js";var i=JSON.parse(`{"path":"/docs/configuration/schema-registry/glue.html","title":"Glue schema registry","lang":"en-US","frontmatter":{},"git":{"updatedTime":1784806813000,"contributors":[{"name":"Mateus Zanatti Saraiva","username":"","email":"mzanattis201@gmail.com","commits":1},{"name":"Claude Opus 4.8 (1M context)","username":"","email":"noreply@anthropic.com","commits":1}],"changelog":[{"hash":"56e60bc5955212725686dff35f41ef8101d05d48","time":1784806813000,"email":"mzanattis201@gmail.com","author":"Mateus Zanatti Saraiva","message":"feat(audit): add audit events for record produce, delete and empty topic (#3110)","coAuthors":[{"name":"Claude Opus 4.8 (1M context)","email":"noreply@anthropic.com"}]}]},"filePathRelative":"docs/configuration/schema-registry/glue.md"}`),a={name:`glue.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="glue-schema-registry" tabindex="-1"><a class="header-anchor" href="#glue-schema-registry"><span>Glue schema registry</span></a></h1><p>Currently ,glue schema registry support is limited to only de-serialisation of avro/protobuf/json serialized messages. It can be configured as below.</p><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre><code class="language-yaml"><span class="line">  <span class="token key atrule">akhq</span><span class="token punctuation">:</span></span>
