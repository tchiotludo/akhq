import{i as e,r as t,s as n,t as r}from"./app-DqyLHbv4.js";var i=JSON.parse(`{"path":"/docs/configuration/schema-registry/glue.html","title":"Glue schema registry","lang":"en-US","frontmatter":{},"git":{"updatedTime":1790171906000,"contributors":[{"name":"nil-malh","username":"nil-malh","email":"31489080+nil-malh@users.noreply.github.com","commits":1,"url":"https://github.com/nil-malh"}],"changelog":[{"hash":"4a7eb41c41cdc62fa16f5c485eeaabd3cf88e825","time":1790171906000,"email":"31489080+nil-malh@users.noreply.github.com","author":"Nil MALHOMME","message":"fix(ui): normalize state handling to uppercase in ConsumerGroupList and TopicGroups (#3260)"}]},"filePathRelative":"docs/configuration/schema-registry/glue.md"}`),a={name:`glue.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="glue-schema-registry" tabindex="-1"><a class="header-anchor" href="#glue-schema-registry"><span>Glue schema registry</span></a></h1><p>Currently ,glue schema registry support is limited to only de-serialisation of avro/protobuf/json serialized messages. It can be configured as below.</p><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre><code class="language-yaml"><span class="line">  <span class="token key atrule">akhq</span><span class="token punctuation">:</span></span>
