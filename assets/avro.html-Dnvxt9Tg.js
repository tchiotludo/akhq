...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div><p>Examples can be found in <a href="https://github.com/tchiotludo/akhq/tree/dev/src/main/java/org/akhq/utils" target="_blank" rel="noopener noreferrer">tests</a>.</p>`,4))])}const f=t(u,[["render",d]]),g=JSON.parse('{"path":"/docs/configuration/avro.html","title":"Avro deserialization","lang":"en-US","frontmatter":{},"git":{"updatedTime":1755594155000,"contributors":[{"name":"mbaurin","username":"mbaurin","email":"86267428+mbaurin@users.noreply.github.com","commits":1,"url":"https://github.com/mbaurin"}],"changelog":[{"hash":"ffec7bf0ac21c27275250f476a95e685105a7f7b","time":1755594155000,"email":"86267428+mbaurin@users.noreply.github.com","author":"Mathieu Baurin","message":"fix(ui): preserve precision for large integer configuration values (#2420)"}]},"filePathRelative":"docs/configuration/avro.md"}');export{f as comp,g as data};
