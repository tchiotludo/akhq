...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div>`,3)]))}const i=s(p,[["render",o]]),u=JSON.parse('{"path":"/docs/configuration/schema-registry/tibco.html","title":"TIBCO schema registry","lang":"en-US","frontmatter":{},"git":{"updatedTime":1748883395000,"contributors":[{"name":"Sverre H. Huseby","username":"","email":"shh+github@thathost.com","commits":1}],"changelog":[{"hash":"75432fd6de5fc2a3e5cf161712026dc18e84a2ae","time":1748883395000,"email":"shh+github@thathost.com","author":"Sverre H. Huseby","message":"feat(auth): do not pass externally mapped groups in token (#2125)"}]},"filePathRelative":"docs/configuration/schema-registry/tibco.md"}');export{i as comp,u as data};
