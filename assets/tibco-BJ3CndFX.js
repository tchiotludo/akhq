import{i as e,r as t,s as n,t as r}from"./app-BtPTA-6v.js";var i=JSON.parse(`{"path":"/docs/configuration/schema-registry/tibco.html","title":"TIBCO schema registry","lang":"en-US","frontmatter":{},"git":{"updatedTime":1782374294000,"contributors":[{"name":"Alexis SOUQUIERE","username":"","email":"alexis.souquiere@michelin.com","commits":1}],"changelog":[{"hash":"9b726e902bfe25ed42c5f81af1cf98ce954e85f6","time":1782374294000,"email":"alexis.souquiere@michelin.com","author":"Alexis SOUQUIERE","message":"feat(deps): upgrade to Micronaut 5 (#3063)"}]},"filePathRelative":"docs/configuration/schema-registry/tibco.md"}`),a={name:`tibco.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="tibco-schema-registry" tabindex="-1"><a class="header-anchor" href="#tibco-schema-registry"><span>TIBCO schema registry</span></a></h1><p>If you are using the TIBCO schema registry, you will also need to mount and use the TIBCO Avro client library and its dependencies. The akhq service in a docker compose file might look something like:</p><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre><code class="language-yaml"><span class="line">  <span class="token key atrule">akhq</span><span class="token punctuation">:</span></span>
