...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div><p>Please note that authentication is done using aws default credentials provider.</p><p>Url key is required to not break the flow.</p>`,5)]))}const i=a(l,[["render",p]]),r=JSON.parse('{"path":"/docs/configuration/schema-registry/glue.html","title":"Glue schema registry","lang":"en-US","frontmatter":{},"git":{"updatedTime":1751399859000,"contributors":[{"name":"Ludovic DEHON","username":"","email":"tchiot.ludo@gmail.com","commits":1}],"changelog":[{"hash":"a39a1d0d4af145e9cd4f72399f919bb36b9900a0","time":1751399859000,"email":"tchiot.ludo@gmail.com","author":"Ludovic DEHON","message":"chore(version): update to 0.26.0"}]},"filePathRelative":"docs/configuration/schema-registry/glue.md"}');export{i as comp,r as data};
