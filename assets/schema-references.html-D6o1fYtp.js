...
<span class="line">    <span class="token punctuation">]</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"></div></div><p>Documentation on Confluent 5.5 and schema references can be found <a href="https://docs.confluent.io/5.5.0/schema-registry/serdes-develop/index.html" target="_blank" rel="noopener noreferrer">here</a>.</p>`,8)]))}const r=n(t,[["render",o]]),u=JSON.parse('{"path":"/docs/configuration/schema-registry/schema-references.html","title":"Schema references","lang":"en-US","frontmatter":{},"git":{"updatedTime":1751399859000,"contributors":[{"name":"Ludovic DEHON","username":"","email":"tchiot.ludo@gmail.com","commits":1}],"changelog":[{"hash":"a39a1d0d4af145e9cd4f72399f919bb36b9900a0","time":1751399859000,"email":"tchiot.ludo@gmail.com","author":"Ludovic DEHON","message":"chore(version): update to 0.26.0"}]},"filePathRelative":"docs/configuration/schema-registry/schema-references.md"}');export{r as comp,u as data};
