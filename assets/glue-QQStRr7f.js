import{i as e,r as t,s as n,t as r}from"./app-B9uCn4Ti.js";var i=JSON.parse(`{"path":"/docs/configuration/schema-registry/glue.html","title":"Glue schema registry","lang":"en-US","frontmatter":{},"git":{"updatedTime":1780993174000,"contributors":[{"name":"Emmanuel","username":"Emmanuel","email":"emmanuel.brard@getyourguide.com","commits":1,"url":"https://github.com/Emmanuel"},{"name":"Claude Opus 4.6","username":"","email":"noreply@anthropic.com","commits":1}],"changelog":[{"hash":"ba27caee7f84325b960f9977ed062e3656826c14","time":1780993174000,"email":"emmanuel.brard@getyourguide.com","author":"Emmanuel","message":"fix(auth): move blocking claim provider call off Netty event loop in HeaderAuthenticationFetcher (#3033)","coAuthors":[{"name":"Claude Opus 4.6","email":"noreply@anthropic.com"}]}]},"filePathRelative":"docs/configuration/schema-registry/glue.md"}`),a={name:`glue.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="glue-schema-registry" tabindex="-1"><a class="header-anchor" href="#glue-schema-registry"><span>Glue schema registry</span></a></h1><p>Currently ,glue schema registry support is limited to only de-serialisation of avro/protobuf/json serialized messages. It can be configured as below.</p><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre><code class="language-yaml"><span class="line">  <span class="token key atrule">akhq</span><span class="token punctuation">:</span></span>
