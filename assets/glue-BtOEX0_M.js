import{i as e,r as t,s as n,t as r}from"./app-DOfdRRPP.js";var i=JSON.parse(`{"path":"/docs/configuration/schema-registry/glue.html","title":"Glue schema registry","lang":"en-US","frontmatter":{},"git":{"updatedTime":1786000264000,"contributors":[{"name":"AlexisSouquiere","username":"AlexisSouquiere","email":"alexis.souquiere@michelin.com","commits":1,"url":"https://github.com/AlexisSouquiere"}],"changelog":[{"hash":"0a0ae81d000c0b1e7042ea862d727cbc8db029e4","time":1786000264000,"email":"alexis.souquiere@michelin.com","author":"AlexisSouquiere","message":"chore(deps): bump repository-dispatch to v4"}]},"filePathRelative":"docs/configuration/schema-registry/glue.md"}`),a={name:`glue.md`};function o(r,i,a,o,s,c){return n(),t(`div`,null,[...i[0]||=[e(`<h1 id="glue-schema-registry" tabindex="-1"><a class="header-anchor" href="#glue-schema-registry"><span>Glue schema registry</span></a></h1><p>Currently ,glue schema registry support is limited to only de-serialisation of avro/protobuf/json serialized messages. It can be configured as below.</p><div class="language-yaml line-numbers-mode" data-highlighter="prismjs" data-ext="yml"><pre><code class="language-yaml"><span class="line">  <span class="token key atrule">akhq</span><span class="token punctuation">:</span></span>
