...
function ErrorToast({ title, message, show }) {
  const style = show ? { display: 'flex', zIndex: 3 } : { display: 'none' };

  return (
    <div
      aria-labelledby="swal2-title"
      aria-describedby="swal2-content"
      className="swal2-popup swal2-toast swal2-show"
      tabIndex="-1"
      role="alert"
      aria-live="polite"
      style={style}
    >
      ...
      <div className="swal2-actions" style={{ display: 'none' }}>
        <button
          ...
          style={{
            display:
              'none; border-left-color: rgb(48, 133, 214); border-right-color: rgb(48, 133, 214)'
          }}
        >
          OK
        </button>
