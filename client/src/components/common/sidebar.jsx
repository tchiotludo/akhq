        ...
        <nav id="khq-sidebar">
          ...
          <ul className="list-unstyled components">
            ...
            <li className={selectedTab === "tail" ? "active" : ""}>
              <Link to={`/${clusterId}/tail`}>
                <i className="fa fa-fw fa-level-down" aria-hidden="true" /> Live
                Tail
              </Link>
            </li>
            {/*</#if>*/}
            ...
            <li className={selectedTab === "group" ? "active" : ""}>
              <Link to={`/${clusterId}/group`}>
                <i className="fa fa-fw fa-object-group" aria-hidden="true" />{" "}
                Consumer Groups
              </Link>
            </li>
            {/*</#if>*/}
            ...
            <li className={selectedTab === "schema" ? "active" : ""}>
              <Link to={`/${clusterId}/schema`}>
                <i className="fa fa-fw fa-cogs" aria-hidden="true" /> Schema
                Registry
              </Link>
            </li>
            {/*</#if>*/}
