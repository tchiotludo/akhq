...
<#-- @ftlvariable name="oidcProvider" type="java.lang.String" -->
<#-- @ftlvariable name="oidcLabel" type="java.lang.String" -->
...
<#if oidcEnabled>
    <div class="khq-login">
        ...
        <a href="${basePath}/oauth/login/${oidcProvider}" class="btn btn-primary btn-lg">${oidcLabel}</a>
    </div>
<#else>
