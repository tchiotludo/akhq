...
//    }
//
//    public List<AclsDTO> findByPrincipal(String clusterId, String encodedPrincipal, ResourceType resourceType) throws ExecutionException, InterruptedException {
//        AccessControl acl = aclRepository.findByPrincipal(clusterId, encodedPrincipal, Optional.of(resourceType));
//
//        return aclMapper.fromAclListToAclDTOList(Collections.singletonList(acl), resourceType);
//    }
//
//    public List<AclsDTO> getAcls(String clusterId, ResourceType resourceType, String id) throws ExecutionException, InterruptedException {
